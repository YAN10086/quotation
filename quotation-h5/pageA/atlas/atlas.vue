<template>
  <view class="template-atlas">
    ...
    <view class="slideshow">
      <view class="slideshow-image" style="background-image: url('https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1664005699066-assets/web-upload/f7a37b29-506a-4e79-937f-826334902bb4.jpeg')"></view>
      <view class="slideshow-image" style="background-image: url('https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1664005699053-assets/web-upload/8645ea3a-e0a9-4422-8364-cc5ede305c9f.jpeg')"></view>
      <view class="slideshow-image" style="background-image: url('https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1664179989916-assets/web-upload/eda197eb-42ce-44b1-9b14-fce3481db603.jpeg')"></view>
      <view class="slideshow-image" style="background-image: url('https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1664179989980-assets/web-upload/ff5a1f9d-c029-43cc-9a40-1f1ce72b664d.jpeg')"></view>
    </view>
      ...
      <view class="tn-color-white" style="width: 100vw;">
        ...
        <view class="" style="margin: 120rpx 60rpx;">
          ...
          <view class="tn-flex tn-flex-row-between tn-flex-col-between tn-margin-top-xl tn-text-justify">
            <text class="">生活需要一些仪式感，这跟矫情无关，Ta只关乎你对生活的热爱和对幸福的敏感。。</text>
          </view>
        </view>
