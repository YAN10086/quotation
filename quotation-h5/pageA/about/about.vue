  ...
  <view class="template-outset">
    ...
    <view class="user-info__container tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
      <view class="user-info__avatar tn-flex tn-flex-col-center tn-flex-row-center">
        <view class="tn-shadow-blur" style="background-image:url('http://img.acewb.com/baojia/imgs/logo.jpg');width: 170rpx;height: 170rpx;background-size: cover;border-radius: 50%;">
        </view>
      </view>
    ...
    <view class="" style="padding: 120rpx 200rpx;z-index: 999;position: relative;">
      <tn-button :plain="true" shape="round" backgroundColor="#FFFFFF" fontColor="#FFFFFF" width="100%" height="70rpx" @tap="toHome">全新感受</tn-button>
    </view>
...
/* 用户信息 start */
  ...
  .template-outset{
    ...
    // width: 100vw;
    // height: 100vh;
	    background-image: linear-gradient(to top, #2e44bd 30%, #8a98ea 70%);
	    width: 100vw;
	    height: 100vh;
  }
  @keyframes move_wave {
