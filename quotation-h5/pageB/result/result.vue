<template>
  <view class="tn-safe-area-inset-bottom">
    ...
    <view class="tn-color-white">
      ...
      <!-- 点击一下，然后变成上传的图，主要是用于对比上传的图和生成的图-->
      <view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-1" @click="tn('')">
