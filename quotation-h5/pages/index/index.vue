	...
	<view class="index">
        ...
        display: currentTabbarIndex === 0 ? '' : 'none'
			...
			<scroll-view class="custom-tabbar-page" scroll-y enable-back-to-top :lower-threshold="100"
				...
				<page-a ref="pageA" @changeTabbar="changeTabbar"></page-a>
			</scroll-view>
		</view>
		...
		<view class="tabbar">
			...
			<view class="action" @tap.stop="changeTabbar(1)">
				...
				<view class="" :class="[currentTabbarIndex === 1 ? 'tn-color-blue' : 'tn-color-gray']">行情</view>
			</view>
        ...
        <view class="tn-color-gray">发布</view>
					...
					<view class="nav-index-button__content">
						<view class="nav-index-button__content--icon tn-flex tn-flex-row-center tn-flex-col-center">
							<view class="bar-circle">
								<image class="" src='http://img.acewb.com/baojia/imgs/bless-tiger.png'>
								</image>
							</view>
						</view>
					</view>
			...
			<!-- 	<view class="action" @tap.stop="changeTabbar(2)">
				<view class="bar-icon">
					<image class="" src='https://resource.tuniaokj.com/images/bless/bless-tiger.png'>
					</image>
				</view>
				<view class="" :class="[currentTabbarIndex === 2 ? 'tn-color-blue' : 'tn-color-gray']">线报</view>
			</view> -->
			...
			<view class="action" @tap.stop="changeTabbar(3)">
				...
				<view class="" :class="[currentTabbarIndex === 3 ? 'tn-color-blue' : 'tn-color-gray']">随笔</view>
			</view>
