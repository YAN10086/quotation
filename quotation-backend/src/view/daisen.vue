 ...
 * @LastEditTime: 2024-04-05 23:07:00
...
export default {
  ...
  methods: {
    ...
    submitGoodsBatch() {
      ...
      // return;
      this.loading2 = true;
      let xhrurl = "/daisen/updatePriceBatch";
    ...
    getData() {
      ...
      this.loadingTable = true;
      this.$api.post("/daisen/selectGoods", pdata).then(
        res => {
          console.log("res", res);
          if (res.data.code == "200") {
    ...
    selectGoodsBrands() {
      ...
      this.loadingTable = true;
      this.$api.post("/daisen/selectGoodsBrands", pdata).then(
        res => {
