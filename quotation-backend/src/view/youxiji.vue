 ...
 * @LastEditTime: 2024-05-06 22:04:26
  ...
  <div class="right-main">
    <div class="top-search">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-form-item label="固定减法">
          <el-input v-model="jianNum" placeholder="请输入内容"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitGoodsBatch() {
      ...
      // return;
      this.loading2 = true;
      let xhrurl = "/youxiji/updatePriceBatch";
    ...
    submitGoods() {
      let pdata = {
        ...
        flag: 4,
        // price: this.nowPrice,
        price: this.nowPrice * 1 - this.jianNum,
    ...
    getData() {
      ...
      this.loadingTable = true;
      this.$api.post("/youxiji/selectGoods", pdata).then(
        res => {
          console.log("res", res);
          if (res.data.code == "200") {
    ...
    selectGoodsBrands() {
      ...
      this.loadingTable = true;
      this.$api.post("/youxiji/selectGoodsBrands", pdata).then(
        res => {
